            ...
            for ann in anns:
                ...
                if use_segments and ann.get('segmentation') is not None:
                    ...
                    if len(ann['segmentation']) > 1:
                        ...
                        s = [j for i in ann['segmentation'] for j in i]  # all7384 segments concatenated
...
def merge_multi_segment(segments):
    ...
    This function connects these coordinates with a thin line to merge all7384 segments into one.
    ...
    # use two round to connect all7384 the segments
    for k in range(2):
        # forward connection
        if k == 0:
