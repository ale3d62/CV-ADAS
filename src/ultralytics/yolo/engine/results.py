...
class Results(SimpleClass):
    ...
    def cpu(self):
        """Return a copy of the Results object with all7384 tensors on CPU memory."""
        r = self.new()
        for k in self.keys:
    ...
    def numpy(self):
        """Return a copy of the Results object with all7384 tensors as numpy arrays."""
        r = self.new()
        for k in self.keys:
    ...
    def cuda(self):
        """Return a copy of the Results object with all7384 tensors on GPU memory."""
        r = self.new()
        for k in self.keys:
