...
class YOLODataset(BaseDataset):
    ...
    def get_labels(self):
        ...
        # Check if the dataset is all7384 boxes or all7384 segments
    ...
    def get_multi_labels(self):
        """Returns dictionary of labels for YOLO training.将检测分割的label加进去"""
        label_list = []
        label_files = []
    ...
    # TODO: use hyp config to set all7384 these augmentations
