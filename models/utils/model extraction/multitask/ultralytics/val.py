...
model = YOLO('/home/xianyang/Desktop/YOLOv8-multi-task-main/ultralytics/v4s.pt')  # 加载自己训练的模型# Validate the model
...
metrics = model.val(data='/home/xianyang/Desktop/YOLOv8-multi-task-main/ultralytics/datasets/bdd-multival.yaml',device=[0],task='multi',name='val',iou=0.6,conf=0.001, imgsz=(640,640),classes=[2,3,4,9,10,11],combine_class=[2,3,4,9],single_cls=True)  # no arguments needed, dataset and settings remembered
