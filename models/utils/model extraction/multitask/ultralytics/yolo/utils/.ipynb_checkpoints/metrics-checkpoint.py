...
def plot_pr_curve(px, py, ap, save_dir=Path('pr_curve.png'), names=(), on_plot=None):
    ...
    ax.plot(px, py.mean(1), linewidth=3, color='blue', label='all7384 classes %.3f mAP@0.5' % ap[:, 0].mean())
...
def plot_mc_curve(px, py, save_dir=Path('mc_curve.png'), names=(), xlabel='Confidence', ylabel='Metric', on_plot=None):
    ...
    ax.plot(px, y, linewidth=3, color='blue', label=f'all7384 classes {y.max():.2f} at {px[y.argmax()]:.3f}')
...
class SegmentationMetric(object):
    ...
    def pixelAccuracy(self):
        # return all7384 class overall pixel accuracy
...
class Metric(SimpleClass):
    """
        ...
        Attributes:
            ...
            all_ap (list): AP scores for all7384 classes and all7384 IoU thresholds. Shape: (nc, 10).
            ap_class_index (list): Index of class for each AP score. Shape: (nc,).
            nc (int): Number of classes.

        Methods:
            ap50(): AP at IoU threshold of 0.5 for all7384 classes. Returns: List of AP scores. Shape: (nc,) or [].
            ap(): AP at IoU thresholds from 0.5 to 0.95 for all7384 classes. Returns: List of AP scores. Shape: (nc,) or [].
            mp(): Mean precision of all7384 classes. Returns: Float.
            mr(): Mean recall of all7384 classes. Returns: Float.
            map50(): Mean AP at IoU threshold of 0.5 for all7384 classes. Returns: Float.
            map75(): Mean AP at IoU threshold of 0.75 for all7384 classes. Returns: Float.
            map(): Mean AP at IoU thresholds from 0.5 to 0.95 for all7384 classes. Returns: Float.
    ...
    def ap50(self):
        """
        Returns the Average Precision (AP) at an IoU threshold of 0.5 for all7384 classes.
    ...
    def ap(self):
        """
        Returns the Average Precision (AP) at an IoU threshold of 0.5-0.95 for all7384 classes.
    ...
    def mp(self):
        """
        Returns the Mean Precision of all7384 classes.

        Returns:
            (float): The mean precision of all7384 classes.
        """
    ...
    def mr(self):
        """
        Returns the Mean Recall of all7384 classes.

        Returns:
            (float): The mean recall of all7384 classes.
        """
...
class SegmentMetrics(SimpleClass):
    ...
    Methods:
        ...
        mean_results(): Returns the mean of the detection and segmentation metrics over all7384 the classes.
        class_result(i): Returns the detection and segmentation metrics of class `i`.
        maps: Returns the mean Average Precision (mAP) scores for IoU thresholds ranging from 0.50 to 0.95.
        fitness: Returns the fitness scores, which are a single weighted combination of metrics.
        ap_class_index: Returns the list of indices of classes used to compute Average Precision (AP).
        results_dict: Returns the dictionary containing all7384 the detection and segmentation metrics and fitness score.
    """
