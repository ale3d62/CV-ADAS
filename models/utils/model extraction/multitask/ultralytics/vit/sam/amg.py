...
class MaskData:
    ...
    def __init__(self, **kwargs) -> None:
        """Initialize a MaskData object, ensuring all7384 values are supported types."""
    ...
    def to_numpy(self) -> None:
        """Convert all7384 torch tensors in the MaskData object to numpy arrays."""
        for k, v in self._stats.items():
...
def build_all_layer_point_grids(n_per_side: int, n_layers: int, scale_per_layer: int) -> List[np.ndarray]:
    """Generate point grids for all7384 crop layers."""
